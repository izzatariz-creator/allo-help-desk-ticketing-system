                    ...
                    <div class="box overflow-hidden pull-up hov-rs">
                        <div class="box-body text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark mb-0 font-weight-500">3400 <small class="text-success"><i
                    ...
                    <div class="box overflow-hidden pull-up hov-rs">
                        <div class="box-body text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark mb-0 font-weight-500">$1,250 <small class="text-danger"><i
                    ...
                    <div class="box overflow-hidden pull-up hov-rs">
                        <div class="box-body text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark mb-0 font-weight-500">1,460 <small class="text-danger"><i
                    ...
                    <div class="box overflow-hidden pull-up hov-rs">
                        <div class="box-body text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark mb-0 font-weight-500">1,700 <small class="text-success"><i
                    ...
                    <div class="box overflow-hidden pull-up hov-rs">
                        <div class="box-body text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark mb-0 font-weight-500">$4,500k <small
                                ...
                                <table class="table no-border">
                                    <thead>
                                        <tr class="text-uppercase bg-lightest">
                                            <th style="min-width: 250px"><span class="text-dark">products</span>
                                            </th>
                                            <th style="min-width: 100px"><span class="text-dark">pruce</span>
                                            </th>
                                            <th style="min-width: 100px"><span class="text-dark">deposit</span>
                                            </th>
                                            <th style="min-width: 150px"><span class="text-dark">agent</span>
                                            </th>
                                            <th style="min-width: 130px"><span class="text-dark">status</span>
                                            </th>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-8">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#"
                                                            class="text-dark font-weight-600 hover-primary mb-1 font-size-16">Vivamus
                                                            consectetur</a>
                                                        <span class="text-mute d-block">Pharetra, Nulla , Nec,
                                                            Aliquet</span>
                                                    </div>
                                                </div>
                                            </td>
