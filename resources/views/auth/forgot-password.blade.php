...
<head>
    ...
    <title>Forget Password Page - Allo Help Desk Ticketing System</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="{{ asset('app-assets/images/pages/forgot-password-v2.svg') }}"
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Enter your email and we'll send you instructions to reset your
                                    ...
                                    @if (session('status'))
                                    <div class="mb-4 font-medium text-sm text-red-600" style="color:green;">
                                        {{ session('status') }}
                                    </div>
                                    @endif
