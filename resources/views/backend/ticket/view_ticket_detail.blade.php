                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <!-- Start Row -->
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="ticket_id" class="form-control" hidden tabindex="-1" aria-hidden="true" value="{{ $editData->id }}">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="ticket_ref" class="form-control" disabled="" tabindex="-1" aria-hidden="true" value="{{ $editData->ticket_ref }}">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col Md-6 -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="user_id" class="form-control" disabled="" tabindex="-1" aria-hidden="true" value="{{ $editData['user']['name'] }}">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col Md-6 -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="title" class="form-control" disabled="" tabindex="-1" aria-hidden="true" value="{{ $editData->title }}">
                                                        @error('title')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="category_id" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="description" id="description" class="form-control" disabled="" tabindex="-1" aria-hidden="true" placeholder="Problem Description" aria-invalid="true" rows="5">{{ $editData->description }}</textarea>
                                                        @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="rsp_id" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Modem</h5>
                                                    <div class="controls">
                                                        <select name="modem_id" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Router</h5>
                                                    <div class="controls">
                                                        <select name="router_id" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Address</h5>
                                                    <div class="controls">
                                                        <input type="text" name="address" class="form-control" disabled="" tabindex="-1" aria-hidden="true" value="{{ $editData->address }}"">
                                                        @error('address')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="technician_id" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Status</h5>
                                                <div class="controls">
                                                    <select name="status" disabled="" tabindex="-1" aria-hidden="true" class="form-control">
